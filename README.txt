...
HDAEnabler2.kext installed with a Realtek AppleHDA.kext enables OS X Realtek ALC onboard audio on Intel based motherboards with a bootable clean install of OS X. HDAEnabler2.kext injects Audio_ID = 2 for non-DSDT systems.
